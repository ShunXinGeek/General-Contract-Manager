    ...
    modal.innerHTML = `
        <div style="position:fixed; top:0; left:0; right:0; bottom:0; background:rgba(0,0,0,0.5); display:flex; align-items:center; justify-content:center; z-index:10000;">
            <div style="background:white; padding:30px; border-radius:12px; width:350px; box-shadow:0 10px 40px rgba(0,0,0,0.3);">
                ...
                <button onclick="handleManualSync()" title="比较本机与云端，保留每项较新的修改" aria-label="智能合并同步：比较本机与云端，保留每项较新的修改" style="width:100%; padding:12px; background:#3498db; color:white; border:none; border-radius:8px; cursor:pointer; font-size:14px; margin-bottom:10px;"><span style="display:block; font-weight:600;">🔄 智能合并同步</span></button>
                <button onclick="handleForceUpload()" title="仅上传本机数据；云端独有的合同和修改将被删除" aria-label="上传云端数据：仅上传本机数据，云端独有的合同和修改将被删除" style="width:100%; padding:12px; background:#c0392b; color:white; border:none; border-radius:8px; cursor:pointer; font-size:14px; margin-bottom:10px;"><span style="display:block; font-weight:600;">⚠️ 上传云端数据</span></button>
